...
// Default Values
define('POSTEXPIRATOR_VERSION','2.3.1.1');
...
function display_expirationdate_quickedit( $column_name, $post_type ) {
	...
	<fieldset class="inline-edit-col-left post-expirator-quickedit">
		...
		<span class="title">Scadenza promozione</span>
			<p><input name="enable-expirationdate" type="checkbox" /><span class="title">Attiva scadenza promozione</span></p>
			<fieldset class="inline-edit-date">
				<legend><span class="title">Scade il:</span></legend>
				<div class="timestamp-wrap">
				    <label><span class="screen-reader-text">Mese</span>
				    <select name="expirationdate_month">
					<option value="01" data-text="Jan">01-Gen</option>
					...
					<option value="05" data-text="May">05-Mag</option>
					<option value="06" data-text="Jun">06-Giu</option>
					<option value="07" data-text="Jul">07-Lug</option>
					<option value="08" data-text="Aug">08-Ago</option>
					<option value="09" data-text="Sep">09-Set</option>
					<option value="10" data-text="Oct">10-Ott</option>
					<option value="11" data-text="Nov">11-Nov</option>
					<option value="12" data-text="Dec">12-Dic</option>
				    </select>
				    </label>
				    <label><span class="screen-reader-text">Giorno</span>
				<input name="expirationdate_day" value="" size="2" maxlength="2" autocomplete="off" type="text"></label>, 
				<label><span class="screen-reader-text">Anno</span>
				<input name="expirationdate_year" value="" size="4" maxlength="4" autocomplete="off" type="text"></label> @ 
				<label><span class="screen-reader-text">Ora</span>
				<input name="expirationdate_hour" value="" size="2" maxlength="2" autocomplete="off" type="text"></label>:
				<label><span class="screen-reader-text">Minuti</span>
...
function display_expirationdate_bulkedit( $column_name, $post_type ) {
	...
	<div class="inline-edit-col post-expirator-quickedit">
		<div class="inline-edit-col">
		<div class="inline-edit-group">
		<span class="title"><?php echo __('Scadenza promozione: puoi aggiornare solo le scadenze gi&agrave; impostate.','post-expirator'); ?></span>
			<fieldset class="inline-edit-date">
				<legend><span class="title">Scadenza promozione</span></legend>
				<div class="timestamp-wrap">
				    <label><span class="screen-reader-text">Mese</span>
				    <select name="expirationdate_month">
				    ...
				    <label><span class="screen-reader-text">Giorno</span>
				<input name="expirationdate_day" placeholder="Giorno" value="" size="2" maxlength="2" autocomplete="off" type="text"></label>,
				<label><span class="screen-reader-text">Anno</span>
				<input name="expirationdate_year" placeholder="Anno" value="" size="4" maxlength="4" autocomplete="off" type="text"></label> @
				<label><span class="screen-reader-text">Ora</span>
				<input name="expirationdate_hour" placeholder="Ora" value="" size="2" maxlength="2" autocomplete="off" type="text"></label>:
				<label><span class="screen-reader-text">Minuti</span>
...
function expirationdate_meta_box($post) {
	...
	$rv[] = '<label for="enable-expirationdate">'.__('Attiva scadenza promozione','post-expirator').'</label></p>';

	if ($default == 'publish') {
		$rv[] = '<em>'.__('The published date/time will be used as the expiration value','post-expirator').'</em><br/>';
	} else {
		$rv[] = '<table><tr>';
		$rv[] = '<th style="text-align: left;">'.__('Anno','post-expirator').'</th>';
		$rv[] = '<th style="text-align: left;">'.__('Mese','post-expirator').'</th>';
		$rv[] = '<th style="text-align: left;">'.__('Giorno','post-expirator').'</th>';
		$rv[] = '</tr><tr>';
		$rv[] = '<td>';
		...
		$rv[] = '<th style="text-align: left;">'.__('Ore','post-expirator').'('.date_i18n('T',mktime(0, 0, 0, $i, 1, date_i18n('Y'))).')</th>';
		$rv[] = '<th style="text-align: left;">'.__('Minuti','post-expirator').'</th>';
		$rv[] = '</tr><tr>';
		$rv[] = '<td>@</td><td>';
	...
	echo '<br/>'.__('Una volta scaduto imposta come: ','post-expirator').': ';
